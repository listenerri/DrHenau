package com.listenerri.drhenau.drcom;
...
public class DrcomService extends Service {
    ...
    private String mHostName = "GILIGILIEYE";   //机器名，可随意
    private String mHostOs = "NOTE7";   //系统名，可随意
    ...
    private void showNotification() {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        .setSmallIcon(R.mipmap.drhenau)
                        .setContentTitle("DrHenau正常运行中")
...
//            boolean wtf = true;
    ...
    private byte[] makeLoginPacket() {
        ...
        byte adapterNum = 0x03; // Windows :07 gdufe 04
        byte ipDog = 0x01;
        byte[] primaryDNS = {(byte) 0xca, (byte) 0xc4, (byte) 0x50, (byte) 0x01};   //每台机子对应的dns和dhcp服务器，可以填0
        byte[] dhcp = {(byte) 0xac, (byte) 0x1c, (byte) 0x15, (byte) 0x01};//同上
        byte[] md5b;
